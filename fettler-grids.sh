...
PIXELS_PER_SQUARE_SIDE3=$(($PIXELS_PER_SQUARE_SIDE * 3))
SQUARE_SIZE3="${PIXELS_PER_SQUARE_SIDE3}x${PIXELS_PER_SQUARE_SIDE3}"
...
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/tile75.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/tile75_soft.png
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/tile60.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/tile60_soft.png

magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/tile75.png ${GRIDDIR}/grid_75_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/tile75_soft.png ${GRIDDIR}/grid_75_soft.png
magick convert -alpha off ${GRIDDIR}/grid_75_hard.png -negate ${GRIDDIR}/grid_25_hard.png
magick convert -alpha off ${GRIDDIR}/grid_75_soft.png -negate ${GRIDDIR}/grid_25_soft.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/tile60.png ${GRIDDIR}/grid_60_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/tile60_soft.png ${GRIDDIR}/grid_60_soft.png
magick convert -alpha off ${GRIDDIR}/grid_60_hard.png -negate ${GRIDDIR}/grid_40_hard.png
magick convert -alpha off ${GRIDDIR}/grid_60_soft.png -negate ${GRIDDIR}/grid_40_soft.png
...
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/cross75.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/cross75_soft.png
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/cross60.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/cross60_soft.png

magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/cross75.png ${GRIDDIR}/cross_75_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/cross75_soft.png ${GRIDDIR}/cross_75_soft.png
magick convert -alpha off ${GRIDDIR}/cross_75_hard.png -negate ${GRIDDIR}/cross_25_hard.png
magick convert -alpha off ${GRIDDIR}/cross_75_soft.png -negate ${GRIDDIR}/cross_25_soft.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/cross60.png ${GRIDDIR}/cross_60_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/cross60_soft.png ${GRIDDIR}/cross_60_soft.png
magick convert -alpha off ${GRIDDIR}/cross_60_hard.png -negate ${GRIDDIR}/cross_40_hard.png
magick convert -alpha off ${GRIDDIR}/cross_60_soft.png -negate ${GRIDDIR}/cross_40_soft.png
...
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/box75.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/box75_soft.png
magick convert -size ${SQUARE_SIZE3} tile:${TMPDIR}/box60.png -blur 0x1 -gravity Center -crop ${SQUARE_SIZE}+0+0 +repage ${TMPDIR}/box60_soft.png

magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/box75.png ${GRIDDIR}/box_75_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/box75_soft.png ${GRIDDIR}/box_75_soft.png
magick convert -alpha off ${GRIDDIR}/box_75_hard.png -negate ${GRIDDIR}/box_25_hard.png
magick convert -alpha off ${GRIDDIR}/box_75_soft.png -negate ${GRIDDIR}/box_25_soft.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/box60.png ${GRIDDIR}/box_60_hard.png
magick convert -size ${CANVAS_SIZE} tile:${TMPDIR}/box60_soft.png ${GRIDDIR}/box_60_soft.png
magick convert -alpha off ${GRIDDIR}/box_60_hard.png -negate ${GRIDDIR}/box_40_hard.png
magick convert -alpha off ${GRIDDIR}/box_60_soft.png -negate ${GRIDDIR}/box_40_soft.png
